...
export const TOOL_PARAMS = z.object({
  project_id: z
    ...
    .describe(
      "The unique identifier (UUID) of the project containing the tasks to delete. This project must exist."
  ...
  task_ids: z
    ...
    .describe(
      "An array of task IDs (UUIDs, 1-100) to be deleted from the specified project."
    ), // Required, array of UUID strings, limits
});
